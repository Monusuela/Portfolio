    ...
    <div>
      <section className={HomeStyle["about"]}>
        ...
        <div className={HomeStyle["about-desc"]}>
          ...
          <p>
            Верстку и создание сайтов изучала самостоятельно и на курсах от ВебКадеми. За это время сделала несколько проектов по верстке и сайтам под ключ. Найти их вы сможете в моем <Link
        ...
        <div className={HomeStyle["about-image"]}>
          <img src="https://businessmir.kz/wp-content/uploads/2016/12/Comp.jpg" alt="Portfolio Image" />
        </div>
        ...
        <div className={HomeStyle["about-desc"]}>
          ...
          <blockquote className={HomeStyle["blockqoute"]}>
            <i>
            Mohinur пришла к нам на проект когда мы были на грани провала всех сроков. Наш сайт был сломан и не работал. Клиенты уходили к конкурентам. Получив макет Mohinur оперативно принялась за работу, на следующий день мы уже видели верстку главной страницы, а еще через день у нас была готовая посадочная страница. Mohinur помогла также загрузить все на хостинг, настроить коды для сбора статистики с сайта. Благодаря её работе мы успели запустить проект к назначенной дате и сделали хорошие продажи!
            </i>
          </blockquote>
